...
MAX_CONCURRENT_REQUESTS = 500 # Adjust based on your server's capacity and client machine
INITIAL_WRITE_CONCURRENCY = 500  # Lower concurrency for initial writes
