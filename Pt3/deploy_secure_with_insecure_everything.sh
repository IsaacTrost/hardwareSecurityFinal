...
CUSTOM_SA_NAME="fithealth-vm-sa"
...
# Create the VM with the custom service account
gcloud compute instances create "$VM_NAME" \
  ...
  --metadata-from-file=startup-script=insecure_startup_script.sh \
